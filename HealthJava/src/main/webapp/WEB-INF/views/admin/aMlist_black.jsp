...
<title>HealthJava 관리자 블랙리스트관리 Page</title>
	...
	<section>
		...
		<div class="adminMainpage">	<%-- adminMainpage --%>
			...
			<a href="admin_main"><img width="150px" height="190px" align="left" alt="adminImage" src="<%=request.getContextPath()%>/images/admin.png"> </a>
				...
				<%-- 전체 틀 회원 수정 테이블 (list) --%>
				<div class="list">
				<h3 align="center">블랙리스트 등록</h3><p>
										
				<%--회원 수정 테이블 --%>
				<c:set var="m" value="${mvo}" />
				<form method="post" id="editForm" action="admin_member_black_ok" >
				...
				<table class="memList" align="center">
					...
					<tr> <%-- 이름 --%>
						...
						<td class="td-inputInfo">
							<input type="text" name="user_name" id="user_name" value="${m.user_name}" size="70" placeholder="ex) 홍길동" readonly style="background-color: #e0e0e0;">
						</td>
					...
					<tr><%-- 생년월일 --%>
						...
						<td class="td-inputInfo"> 
							<input type="text" name="user_birth" id="user_birth" value="${m.user_birth}" size="70" placeholder="ex) 990312" readonly style="background-color: #e0e0e0;">
						</td>
					<tr>
						<td class="td-infoPs"></td>
					</tr>
					...
					<tr><%-- 성별--%>
						...
						<td class="td-inputInfo"> 
							<input type="text" name="user_gender" id="user_gender" value="${m.user_gender}" size="70" placeholder="ex) 남자, 여자" readonly style="background-color: #e0e0e0;">
						</td>
					<tr>
						<td class="td-infoPs"></td>
					</tr>
					...
					<tr> <%--주소 --%>
						...
						<td class="td-inputInfo">
						<%-- 우편 번호 --%>
						<input type="text" name="postCode" id="postCode" value="${m.postCode}" size="20" placeholder="우편번호" readonly style="background-color: #e0e0e0;"/>&nbsp;&nbsp;
						<input id="btn2" type="button" value="주소검색"/>
						</td>
					</tr>
					<tr><%-- 기본주소 --%>
						<td class="td-inputInfo">
							<input type="text" name="roadAddr" id="roadAddr" value="${m.roadAddr}"	size="70" placeholder="주소" readonly style="background-color: #e0e0e0;">
						</td>
					</tr>
					<tr><%-- 상세주소 --%>
						<td class="td-inputInfo"><input type="text" name="detailAddr" id="detailAddr" value="${m.detailAddr}" size="70" placeholder="상세주소" readonly style="background-color: #e0e0e0;"></td>
					</tr>
					<tr>
						<td class="td-infoPs"></td>
					</tr>
					...
					<tr><%-- 이메일 --%>
						...
						<td class="td-inputInfo"><input type="email" name="user_email" id="user_email" value="${m.user_email}" size="70" placeholder="ex) abcdefg11@naver.com" readonly style="background-color: #e0e0e0;">
						</td>
					</tr>
					<tr>
						<td class="td-infoPs"></td>
					...
					<tr><%-- 연락처 --%>
						...
						<td class="td-inputInfo">
								<input type="text" name="user_phone" id="user_phone" size="70" value="${m.user_phone}" size="70" placeholder="ex) 01012345678" readonly style="background-color: #e0e0e0;">
						</td>
					</tr>
					<tr>
						<td class="td-infoPs"></td>
					</tr>
					<c:if test="${m.user_id != 'admin'}">
					<tr><%-- 회원유형 --%>
						<th rowspan="2" class="th-list">회원 유형</th>
						<td class="td-inputInfo">
								<input type="text" name="user_state" id="user_state" size="70" value="${m.user_state}" size="70" placeholder="ex) 회원 0, 블랙리스트 1, 탈퇴회원 2">
						</td>
					</tr>
					<tr>
					...
					<tr><%-- 회원유형 --%>
						<th rowspan="2" class="th-list">회원 유형</th>
						<td class="td-inputInfo">
								<input type="text" name="user_state" id="user_state" size="70" value="${m.user_state}" size="70" readonly style="background-color: #e0e0e0;">
						</td>
					</tr>
					<tr>
						<td class="td-infoPs" style="color:red;">* 회원 0, 블랙리스트 1, 탈퇴회원 2</td>
				...
				<input id="btn" type="button" value="목록보기" onclick="location.href ='admin_main';" />
					...
					<script> <%-- 수정 버튼 클릭시 --%>						
						function black_check() {
							...
							answer=confirm("회원 유형을 변경하시겠습니까?");
