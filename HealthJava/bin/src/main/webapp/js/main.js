$(document).on('click', '.page-link', function() {
  ...
  return x.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
      ...
      for (let i = 1; i <= totalPages; i++) {
        const html = `<b class="page-link" data-page="${i}" style="display: inline-block; margin: 0 5px;">[${i}]</b>`;
      ...
      for (let i = 0; i < flist.length; ++i) {
        const html = `
          <div class="a" style="width:200px; float:left; margin: 100px 100px;">
            <a href="/product/detail/${flist[i].product_no}"><img src="../upload${flist[i].product_cont1}" width="400px" height="200px" /></a>
            <br>
