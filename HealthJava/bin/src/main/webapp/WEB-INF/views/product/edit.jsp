		...
		<section>
			<div class="main">
				<%-- main 시작 --%>
					...
					<%-- 상품 등록 form --%>
				 <form action="/product/edit_ok" method="post" enctype="multipart/form-data">
						<div class="productTitle">
							<h3 align="center">상품&nbsp;수정</h3>
							<p>
							 <br><br><br>
							  <input type="hidden" name="product_no" id="product_no" value="${detail.product_no}" >
								<%-- 상품 등록 --%>
							<table class="productForm" align="center">
								...
								<tr>
									...
									<td align="left"><input type="text" class="#"
										name="product_title" id="product_title" value="${detail.product_title}"></td>
								</tr>
								<p>
								<tr>
									<th></th>
								...
								<tr>
									<th><b>가격</b></th>
									<td align="left"><input type="text" class="#"
										name="product_price" width="1000px" value="${detail.product_price}">&nbsp;원</td>
								</tr>
								...
								<tr>
									<th>제조사</th>
									<td align="left"><input type="text" class="#"
										name="product_maker" value="${detail.product_maker}"></td>
								</tr>
								<p>
								<tr>
    <th>카테고리1</th>
